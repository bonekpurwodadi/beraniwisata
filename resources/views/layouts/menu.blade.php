    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="{{url('/'.'#about')}}" style="font-size:20px;">Tentang Kami</a>
          </li>
          <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="{{url('/'.'#portfolio')}}" style="font-size:20px;">Promo Terbaru</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="{{url('/'.'#kontak')}}" style="font-size:20px;">Kontak</a>
          </li>
        </ul>
      </div>
    </div>
